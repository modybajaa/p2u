	...
	<footer class="footer">
		<div class="container">
			...
			<div class="footer-cont-info">
				...
				<?php } ?>
                <img src="<?php echo EYOOM_THEME_URL; ?>/image/Logo-p2u.png" class="site-logo" alt="<?php echo $config['cf_title']; ?>">
			...
			<div class="footer-copyright">
				<span>Copyright </span>&copy;<strong class="text-black f-w-400">P2U</strong>. All Rights Reserved.
			</div>
		</div>
	</footer>
	<?php /*----- footer 끝 -----*/ ?>
